		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>
					...
					style="width: 180px;" required="required" value="${dto.sangname }"> 
				</td>
			</tr>
			<tr>
				<th>상품가격</th>
			...
			<tr>
				...
				<td>
					...
					style="width: 200px;" required="required" value="${dto.sangcolor }"> 
				</td>
			</tr>
			<tr>
				<th>입고일</th>
				<td>
					...
					style="width: 250px;" required="required" value="${dto.sangipgo }"> 
				</td>
			</tr>
			<tr>
