		...
		<table class="table table-bordered" style="width: 570px;">
			...
			<tr>
				...
				<td>
					...
					class="form-control" style="width: 140px" value="<%=dto.getNickname()%>">
				</td>
			...
			<tr>
				<td colspan="4">
					...
					class="form-dark"><%=dto.getContent()%></textarea>
			...
			<tr>
				<td colspan="4" align="center">
					<input type="submit" value="수정" class="btn btn-outline-success" style="width: 100px;">
