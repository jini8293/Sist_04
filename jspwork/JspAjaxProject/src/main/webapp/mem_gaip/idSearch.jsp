	...
	if(key==null){
		...
		<div style="margin: 10px 30px;">
			<form action="idSearch.jsp" method="post">
				...
				<button type="submit" class="btn btn-outline-success" style="margin-left: 10px;">중복체크</button>
				</div>
			</form>
		</div>
		<%
		...
		if(b){
			...
			<div style="margin: 50px 50px;">
				...
				<img src="../image/jquery_img/03.png" width="60" align="left">
				
				<button type="button" class="btn btn-outline-info" onclick="saveId('<%=m_id%>')">적용하기</button>
				<button type="button" class="btn btn-outline-danger" onclick="location.href='idSearch.jsp'">다시입력</button>
			</div>
			<%
		}
	}
